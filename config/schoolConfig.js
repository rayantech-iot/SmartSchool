// ============================================================
// config/schoolConfig.js — Niveaux, cycles, capacités, créneaux
// ============================================================
...
/** Pauses obligatoires (aucun cours ne peut être planifié sur ces créneaux) */
const PAUSES = [
...
/**
 * Créneaux de cours (hors pauses)
 * Matin : 08h-10h | 10h30-12h | Après-midi : 14h-16h | 16h15-18h15
 */
...
/** Timeline d'un jour : pauses + séances triées par heure */
